...
File in `esercizi/`. Approccio lab_: leggi il codice, predici il comportamento, poi esegui. Non copiare passivamente.
...
*PDF da richiedere a Lorenzo sessione per sessione.*
